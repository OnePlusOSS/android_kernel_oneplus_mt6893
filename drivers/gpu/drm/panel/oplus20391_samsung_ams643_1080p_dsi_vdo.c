...
#include "../mediatek/mtk_corner_pattern/oplus20391_AMS643XY04_data_hw_roundedpattern.h"
#endif
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "20391,samsung,dphy,vdo", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus20391_samsung_ams643_1080p_dsi_vdo",
		.owner = THIS_MODULE,
