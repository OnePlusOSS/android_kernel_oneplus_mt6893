...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	if (is_project(20651) || is_project(20652)) {
#if defined(CONFIG_MTK_PANEL_EXT)
		memcpy(ext_params.vendor, "ili9882n_innolux_carr", strlen("ili9882n_innolux_carr") > 31?31:strlen("ili9882n_innolux_carr"));
		memcpy(ext_params.manufacture, "INNOLUX", strlen("INNOLUX") > 31?31:strlen("INNOLUX"));
#endif
		register_device_proc("lcd","ili9882n_innolux_carr","INNOLUX");
	} else {
#if defined(CONFIG_MTK_PANEL_EXT)
		memcpy(ext_params.vendor, "ili9882n_innolux", strlen("ili9882n_innolux") > 31?31:strlen("ili9882n_innolux"));
		memcpy(ext_params.manufacture, "INNOLUX", strlen("INNOLUX") > 31?31:strlen("INNOLUX"));
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus20015_ili9882n_innolux_vdo_lcm_drv",
			.owner = THIS_MODULE,
