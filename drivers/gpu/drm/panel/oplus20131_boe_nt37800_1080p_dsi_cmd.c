...
#include "../mediatek/mtk_corner_pattern/oplus20131_BOE_NT37800_data_hw_roundedpattern.h"
#endif
...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx,0xB7,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xC3,0x9A,0x01,0x9F,0xD0,0x20,0x01,0x00);
		lcm_dcs_write_seq_static(ctx, 0x2C);
...
static struct LCM_setting_table lcm_normal_to_aod_sam[] = {
    ...
    {REGFLAG_CMD, 9, {0xB7,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E}},
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus20131_boe_nt37800_1080p_dsi_cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus20131_boe_nt37800_1080p_dsi_cmd",
		.owner = THIS_MODULE,
