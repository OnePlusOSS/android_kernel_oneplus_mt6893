...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	//OSC track
	lcm_dcs_write_seq_static(ctx,0xC3,0x8D,0x01,0x98,0xD0,0x22,0x02,0x00);
	//OVP
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xC3,0x9A,0x01,0x9B,0xD0,0x22,0x02,0x00);
		lcm_dcs_write_seq_static(ctx, 0x2C);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "TM_NT37701_42", "TM_nt37701_2048");
	ctx->hbm_en = false;
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus20171_tianma_nt37701_42_1080p_dsi_cmd",
		.owner = THIS_MODULE,
