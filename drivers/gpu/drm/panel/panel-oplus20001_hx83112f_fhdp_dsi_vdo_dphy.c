...
static void tm_panel_init(struct tianma *ctx)
{
	...
	tm_dcs_write_seq_static(ctx,0xBD,0x01);
	tm_dcs_write_seq_static(ctx,0xB1,0xA4);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xB2,0x00,0x02,0x18,0x90,0x60,0x00,0x1C,0x4C,0x10,0x08,0x00,0x6E,0x21,0x01,0x00,0x00,0x00,0x00,0x80,0x10,0xA3,0x87);
	tm_dcs_write_seq_static(ctx,0xB4,0x75,0x0C,0x75,0x0C,0x00,0x00,0x02,0x6F,0x02,0x6F,0x00,0x00,0x04,0x70,0x00,0x00,0x05,0x05,0x00,0x1A,0x00,0x0B,0x00,0x0D,0x00,0x01,0x00,0x00,0x90,0x00,0xFF,0x00,0xFF,0x00,0x01,0x01);
	tm_dcs_write_seq_static(ctx,0xE9,0xC5);
	tm_dcs_write_seq_static(ctx,0xBA,0x11);
	tm_dcs_write_seq_static(ctx,0xE9,0xC9);
	tm_dcs_write_seq_static(ctx,0xBA,0x09);
	tm_dcs_write_seq_static(ctx,0xE9,0xCF);
	tm_dcs_write_seq_static(ctx,0xBA,0x01);
	tm_dcs_write_seq_static(ctx,0xE9,0x3F);
	tm_dcs_write_seq_static(ctx,0xBD,0x01);
	tm_dcs_write_seq_static(ctx,0xE9,0xC5);
	tm_dcs_write_seq_static(ctx,0xBA,0x04);
	tm_dcs_write_seq_static(ctx,0xE9,0x3F);
	tm_dcs_write_seq_static(ctx,0xBD,0x03);
	tm_dcs_write_seq_static(ctx,0xE9,0xC5);
	tm_dcs_write_seq_static(ctx,0xBA,0x3C,0x69);
	tm_dcs_write_seq_static(ctx,0xE9,0x3F);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xE7,0x65,0x5B,0x10,0x10,0x3A,0x87,0x39,0x87,0x3A,0x87,0x04,0x02,0x00,0x00,0x02,0x02,0x12,0x05,0xFF,0xFF,0x39,0x87,0x3A,0x87,0x06,0x00,0x00,0x48,0x17,0x03,0x69,0x00,0x00,0x00,0x50,0x50,0x0A,0x00,0x40,0x01,0x00,0x0D,0x0B,0x05);
	tm_dcs_write_seq_static(ctx,0xBD,0x01);
	tm_dcs_write_seq_static(ctx,0xE7,0x12,0x50,0x8E,0x01,0x94,0x05,0x8A,0x10);
	tm_dcs_write_seq_static(ctx,0xBD,0x02);
	tm_dcs_write_seq_static(ctx,0xB1,0x27,0x27);
	tm_dcs_write_seq_static(ctx,0xE7,0x02,0x02,0x02,0x00,0x70,0x01,0x03,0x01,0x03,0x01,0x03,0x22,0x20,0x28,0x40,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x28);
	tm_dcs_write_seq_static(ctx,0xB4,0x12);
	tm_dcs_write_seq_static(ctx,0xE9,0xCB);
	tm_dcs_write_seq_static(ctx,0xB4,0x42);
	tm_dcs_write_seq_static(ctx,0xE9,0x3F);
	tm_dcs_write_seq_static(ctx,0xBD,0x03);
	tm_dcs_write_seq_static(ctx,0xE7,0x04,0x04);
	tm_dcs_write_seq_static(ctx,0xE1,0x01);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xE1,0x11,0x00,0x00,0x89,0x30,0x80,0x09,0x60,0x04,0x38,0x00,0x08,0x02,0x1C,0x02,0x1C,0x00,0xAA,0x02,0x0E,0x00,0x20,0x00,0x2B,0x00,0x07,0x00,0x0C,0x0D,0xB7,0x0C,0xB7,0x18,0x00,0x1B,0xA0,0x03,0x0C,0x20,0x00,0x06,0x0B,0x0B,0x33,0x0E,0x1C,0x2A,0x38,0x46,0x54,0x62,0x69,0x70,0x77,0x79,0x7B,0x7D,0x7E,0x01,0x02,0x01,0x00,0x09);
	tm_dcs_write_seq_static(ctx,0xBD,0x01);
	tm_dcs_write_seq_static(ctx,0xE1,0x40,0x09,0xBE,0x19,0xFC,0x19,0xFA,0x19,0xF8,0x1A,0x38,0x1A,0x78,0x1A,0xB6,0x2A,0xF6,0x2B,0x34,0x2B,0x74,0x3B,0x74,0x6B,0xF4);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xCB,0x5F,0x21,0x06,0xEC);
	tm_dcs_write_seq_static(ctx,0xC7,0xF0,0x20);
	tm_dcs_write_seq_static(ctx,0xE9,0xCC);
	tm_dcs_write_seq_static(ctx,0xC7,0x60);
	tm_dcs_write_seq_static(ctx,0xE9,0x3F);
	tm_dcs_write_seq_static(ctx,0xC0,0x35,0x35,0x00,0x00,0x12,0x1A,0x60,0x03);
	tm_dcs_write_seq_static(ctx,0xBD,0x01);
	tm_dcs_write_seq_static(ctx,0xC7,0x44);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xC9,0x00,0x1E,0x0F,0xE2);
	tm_dcs_write_seq_static(ctx,0xBC,0x04);
	tm_dcs_write_seq_static(ctx,0xD1,0x07);
	tm_dcs_write_seq_static(ctx,0xBD,0x02);
	tm_dcs_write_seq_static(ctx,0xBA,0x73,0x23);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xBD,0x01);
	tm_dcs_write_seq_static(ctx,0xBF,0x0B);
	tm_dcs_write_seq_static(ctx,0xBD,0x00);
	tm_dcs_write_seq_static(ctx,0xB7,0x00,0x00);
