...
static struct LCM_setting_table lcm_aod_to_normal[] = {
	...
	{REGFLAG_CMD,2,{0x38,0x32}},//fps is 60

	{REGFLAG_CMD,4,{0xFF,0x78,0x38,0x0F}},
	{REGFLAG_CMD,2,{0x6E,0x12}},

	{REGFLAG_CMD,2,{0x92,0x00}},
	{REGFLAG_CMD,2,{0x93,0xD8}},
	{REGFLAG_CMD,2,{0x94,0x11}},
	{REGFLAG_CMD,2,{0x95,0x10}},
	{REGFLAG_CMD,2,{0x96,0x00}},
	{REGFLAG_CMD,2,{0x9E,0x00}},
	{REGFLAG_CMD,2,{0xA1,0x14}},
	{REGFLAG_CMD,2,{0xA2,0x14}},
	{REGFLAG_CMD,2,{0xA3,0xF3}},
	{REGFLAG_CMD,2,{0xA4,0x00}},
	{REGFLAG_CMD,2,{0xA6,0x63}},
	{REGFLAG_CMD,2,{0xA7,0x26}},
	{REGFLAG_CMD,2,{0xA9,0x3C}},
	{REGFLAG_CMD,2,{0xAA,0x08}},
	{REGFLAG_CMD,2,{0xD8,0x4B}},
	{REGFLAG_CMD,2,{0xD9,0x80}},

	{REGFLAG_CMD,2,{0xDA,0x11}},
	{REGFLAG_CMD,2,{0xDB,0x14}},
	{REGFLAG_CMD,2,{0xDC,0xDA}},
	{REGFLAG_CMD,2,{0xDD,0xC0}},
	{REGFLAG_CMD,2,{0xDE,0x12}},
	{REGFLAG_CMD,2,{0xE4,0x21}},
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x89, 0x30, 0x80,\
								0x09, 0x60, 0x04, 0x38, 0x00, 0x14, 0x04, 0x38, 0x04, 0x38, 0x02, 0x00, \
								0x03, 0x1C, 0x00, 0x20, 0x02, 0x8C, 0x00, 0x0F, 0x00, 0x0C, 0x05, 0x0E, \
								0x02, 0x8B, 0x18, 0x00, 0x10, 0xF0, 0x03, 0x0C, 0x20, 0x00, 0x06, 0x0B, \
								0x0B, 0x33, 0x0E, 0x1C, 0x2A, 0x38, 0x46, 0x54, 0x62, 0x69, 0x70, 0x77, \
								0x79, 0x7B, 0x7D, 0x7E, 0x01, 0x02, 0x01, 0x00, 0x09, 0x40, 0x09, 0xBE, \
								0x19, 0xFC, 0x19, 0xFA, 0x19, 0xF8, 0x1A, 0x38, 0x1A, 0x78, 0x1A, 0xB6, \
								0x2A, 0xF6, 0x2B, 0x34, 0x2B, 0x74, 0x3B, 0x74, 0x6B, 0xF4, 0x00, 0x00, \
								0x00, 0x00, 0x00, 0x00);

	lcm_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x08);
	lcm_dcs_write_seq_static(ctx,0x45,0x4C);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x38, 0x12);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x10);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x38, 0x05);
	lcm_dcs_write_seq_static(ctx, 0xA2, 0x56);
	lcm_dcs_write_seq_static(ctx, 0x1D, 0x68);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x38, 0x08);
	...
	lcm_dcs_write_seq_static(ctx,0x38,0x32);//fps is 60

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x38, 0x0F);
	lcm_dcs_write_seq_static(ctx, 0x6E, 0x12);//OSC 121.5

	lcm_dcs_write_seq_static(ctx,0x92,0x00);
	lcm_dcs_write_seq_static(ctx,0x93,0xD8);
	lcm_dcs_write_seq_static(ctx,0x94,0x11);
	lcm_dcs_write_seq_static(ctx,0x95,0x10);
	lcm_dcs_write_seq_static(ctx,0x96,0x00);
	lcm_dcs_write_seq_static(ctx,0x9E,0x00);
	lcm_dcs_write_seq_static(ctx,0xA1,0x14);
	lcm_dcs_write_seq_static(ctx,0xA2,0x14);
	lcm_dcs_write_seq_static(ctx,0xA3,0xF3);
	lcm_dcs_write_seq_static(ctx,0xA4,0x00);
	lcm_dcs_write_seq_static(ctx,0xA6,0x63);
	lcm_dcs_write_seq_static(ctx,0xA7,0x26);
	lcm_dcs_write_seq_static(ctx,0xA9,0x3C);
	lcm_dcs_write_seq_static(ctx,0xAA,0x08);
	lcm_dcs_write_seq_static(ctx,0xD8,0x4B);
	lcm_dcs_write_seq_static(ctx,0xD9,0x80);

	lcm_dcs_write_seq_static(ctx,0xDA,0x11);
	lcm_dcs_write_seq_static(ctx,0xDB,0x14);
	lcm_dcs_write_seq_static(ctx,0xDC,0xDA);
	lcm_dcs_write_seq_static(ctx,0xDD,0xC0);
	lcm_dcs_write_seq_static(ctx,0xDE,0x12);
	lcm_dcs_write_seq_static(ctx,0xE4,0x21);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == AFTER_DSI_POWERON) {
		lcm_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x02);
		lcm_dcs_write_seq_static(ctx,0x38,0x31);
		lcm_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x00);
    }
}
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		lcm_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x02);
		lcm_dcs_write_seq_static(ctx,0x38,0x32);
		lcm_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x00);
...
static struct LCM_setting_table lcm_normal_to_aod_sam[] = {
	...
	{REGFLAG_CMD, 100,
	{0x20,0x00,0x00,0x00,0x00,0x00,0x11,0x00,0x00,0x89,0x30,0x80,0x09,0x60,0x04,0x38,0x00,0x14,0x04,0x38,0x04,0x38,0x02,0x00,0x03,0x1C,0x00,0x20,0x02,0x8C,0x00,0x0F,0x00,0x0C,0x05,0x0E,0x02,0x8B,0x18,0x00,0x10,0xF0,0x03,0x0C,0x20,0x00,0x06,0x0B,0x0B,0x33,0x0E,0x1C,0x2A,0x38,0x46,0x54,0x62,0x69,0x70,0x77,0x79,0x7B,0x7D,0x7E,0x01,0x02,0x01,0x00,0x09,0x40,0x09,0xBE,0x19,0xFC,0x19,0xFA,0x19,0xF8,0x1A,0x38,0x1A,0x78,0x1A,0xB6,0x2A,0xF6,0x2B,0x34,0x2B,0x74,0x3B,0x74,0x6B,0xF4,0x00,0x00,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 4, {0xFF,0x78,0x38,0x08}},
	{REGFLAG_CMD, 2, {0x45,0x4C}},
	{REGFLAG_CMD, 4, {0xFF,0x78,0x38,0x12}},
	{REGFLAG_CMD, 2, {0xC0,0x10}},

	{REGFLAG_CMD, 4, {0xFF,0x78,0x38,0x05}},
	{REGFLAG_CMD, 2, {0xA2,0x56}},
	{REGFLAG_CMD, 2, {0x1D,0x68}},
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "21015_TM_ili7838", "TM_ili7838_2048");
	ctx->hbm_en = false;
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus21015_tianma_ili7838_1080p_dsi_cmd",
		.owner = THIS_MODULE,
