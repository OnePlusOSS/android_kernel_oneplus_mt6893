		...
		void *handle, unsigned int level)
{
	...
	char bl_tb5[] = {0xE0, 0x00,0x00,0x1B,0x4B,0x00,0x8F,0xBF,0xE4,0x15,0x1C,0x47,0x86,0x25,0xB4,0xFD,0x34,0x2A,0x6B,0xAA,0xD0,0x3F,0x02,0x29,0x4E,0x3F,0x6A,0x8C,0xBC,0x0F,0xD3,0xD9};
	char bl_tb6[] = {0xE1, 0x00,0x00,0x1B,0x4B,0x00,0x8F,0xBF,0xE4,0x15,0x1C,0x47,0x86,0x25,0xB4,0xFD,0x34,0x2A,0x6B,0xAA,0xD0,0x3F,0x02,0x29,0x4E,0x3F,0x6A,0x8C,0xBC,0x0F,0xD3,0xD9};
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "ILI7807s_TM_OdinA", "OdinA_ili_tm3276");
	pr_info("%s-\n", __func__);
...
static const struct of_device_id tianma_of_match[] = {
	{
		.compatible = "oplus21041,tianma,ili7807s,cphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
			...
			.name = "oplus21041_tianma_ili7807s_cphy_vdo",
			.owner = THIS_MODULE,
