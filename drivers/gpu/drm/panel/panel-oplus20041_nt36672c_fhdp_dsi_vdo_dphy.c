...
//UI_PWM DUTY
	...
	//jdi_dcs_write_seq_static(ctx, 0xB8, 0x06);
...
static struct drm_display_mode default_mode = {
	...
	.vdisplay = 2400,
	.vsync_start = VAC + 1275,//VFP
	.vsync_end = VAC + 1275 + 10,//VSA
	.vtotal = VAC + 1275 + 10 + 10,//VBP4948
	.vrefresh = 60,
};
...
static struct drm_display_mode performance_mode = {
	...
	.vdisplay = VAC,
	.vsync_start = VAC + 48,//VFP
	.vsync_end = VAC + 48 + 10,//VSA
	.vtotal = VAC + 48 + 10 + 10,//VBP
	.vrefresh = 90,
};
...
static struct mtk_panel_params ext_params = {
	...
	.vendor = "NT36672C_BOE",
	.manufacture = "nt_boe_4096",
};

static struct mtk_panel_params ext_params_90hz = {
	.pll_clk = 553,
	.vfp_low_power = 1275,//60hz
	.cust_esd_check = 0,
	.esd_check_enable = 1,
	.lcm_esd_check_table[0] = {
		.cmd = 0x0A, .count = 1, .para_list[0] = 0x9C, .mask_list[0] = 0x9C,
...
#endif
	register_device_proc("lcd", "NT36672C_BOE", "nt_boe_4096");
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
			.name = "panel-oplus20041_nt36672c_fhdp_dsi_vdo_dphy",
			.owner = THIS_MODULE,
