...
#include "../mediatek/mtk_corner_pattern/oplus216CA_AMS643YE01_data_hw_roundedpattern.h"
#endif
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[soso]216CA samsung probe\n");
	if (dsi_node) {
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus216CA_samsung_ams643ye01_1080p_dsi_cmd,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus216CA_samsung_ams643ye01_1080p_dsi_cmd,lcm",
		.owner = THIS_MODULE,
