...
#include "../mediatek/mtk_corner_pattern/oplus21712_AMS643YE01_data_hw_roundedpattern.h"
#endif
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[soso]21712 samsung probe\n");
	if (dsi_node) {
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus21712_samsung_ams643ye01_1080p_dsi_cmd,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus21712_samsung_ams643ye01_1080p_dsi_cmd,lcm",
		.owner = THIS_MODULE,
