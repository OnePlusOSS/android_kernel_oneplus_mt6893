	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xC3,0x93,0x01,0x8F,0xD0,0x20,0x81,0x00);
		lcm_dcs_write_seq_static(ctx, 0x2C);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus20645_tianma_nt37701_32_1080p_dsi_cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus20645_tianma_nt37701_32_1080p_dsi_cmd",
		.owner = THIS_MODULE,
