...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	if ((0 == tp_gesture_enable_flag()) || (esd_flag == 1) || (is_shutdown_flow == 1)) {
	pr_info("%s:  \n", __func__);
	ctx->reset_gpio =
...
static const struct of_device_id jdi_of_match[] = {
	{
		.compatible = "oplus2163b,boe,ili9883a,dphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus2163b_ili9883a_boe_vdo_lcm_drv",
			.owner = THIS_MODULE,
