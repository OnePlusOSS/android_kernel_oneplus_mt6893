...
//add for cabc
	...
	lcm_dcs_write_seq_static(ctx, 0x61, 0x22);
	...
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78,0x07,0x1E);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x27);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78,0x07,0x00);
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "oplus21041,jdi,ili7807s,cphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.driver = {
			...
			.name = "oplus21041_jdi_ili7807s_cphy_vdo",
			.owner = THIS_MODULE,
