...
#include "../mediatek/mtk_corner_pattern/oplus2169F_AMS643YE01_data_hw_roundedpattern.h"
#endif
...
static struct LCM_setting_table lcm_finger_HBM_on_setting[] = {
	/*DLY ON*/
	{REGFLAG_CMD,3, {0xF0, 0x5A, 0x5A}},
	{REGFLAG_CMD,3, {0xB0, 0x91, 0x63}},
	{REGFLAG_CMD,2, {0x63, 0x30}},
	{REGFLAG_CMD,3, {0xF0, 0xA5, 0xA5}},
	/*HBM ON*/
	{REGFLAG_CMD,3, {0xF0, 0x5A, 0x5A}},
	{REGFLAG_CMD,2, {0x53,0xE0}},
...
static int panel_osc_freq_change(void *dsi, dcs_write_gce cb, void *handle, bool en)
{
	...
	if (en == 0) {
		osc_tb7[1] = 0x8E, osc_tb7[2] = 0x82;    //OSC 167M base MIPI 300M
	} else if (en == 1) {
		osc_tb7[1] = 0x90, osc_tb7[2] = 0x37;    //OSC 169M base MIPI 300M
	}
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[soso]2169F samsung probe\n");
	if (dsi_node) {
	...
	if (ret < 0)
		return ret;
#endif
	//register_device_proc("lcd", "AMS643YE05", "samsung2048");
	ctx->hbm_en = false;
	pr_info("%s zjb+\n", __func__);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus2169F_samsung_ams643ye01_1080p_dsi_cmd,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus2169F_samsung_ams643ye01_1080p_dsi_cmd,lcm",
		.owner = THIS_MODULE,
