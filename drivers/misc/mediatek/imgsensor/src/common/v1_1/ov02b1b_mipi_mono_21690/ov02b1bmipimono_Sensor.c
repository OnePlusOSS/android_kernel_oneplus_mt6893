...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV02B1B_SENSOR_ID_21690,
...
static struct imgsensor_struct imgsensor = {
    ...
    .i2c_write_id = 0x79,//record current sensor's i2c write id
};
...
{
    //printk("ov02b1b 0x02:0x%x, 0x03:0x%x",(read_cmos_sensor(0x02) << 8), read_cmos_sensor(0x03));
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            //printk("OV02B1B sensor_id : 0x%x\n", *sensor_id);
            //printk("OV02B1B imgsensor_info.sensor_id : 0x%x\n", imgsensor_info.sensor_id);
            if (*sensor_id == OV02B10_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                printk("OV02B1B get_imgsensor_id success: i2c_addr:0x%x sensorId:0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                return ERROR_NONE;
            }
            /*else {
                printk("OV02B1B get_imgsensor_id failed: i2c_write_id:0x%x  sensorid:0x%x\n",imgsensor.i2c_write_id, *sensor_id);
            }*/
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        //printk("OV02B1B get_imgsensor_id failed\n");
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            sensor_id = return_sensor_id();
            //printk("ov02b1b open sensor_id:0x%x\n", sensor_id);
            if (sensor_id == OV02B10_SENSOR_ID) {
                sensor_id = imgsensor_info.sensor_id;
...
UINT32 OV02B1B_MIPI_MONO_21690_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	//printk("OV02B1B_MIPI_MONO_SensorInit start");
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}   
