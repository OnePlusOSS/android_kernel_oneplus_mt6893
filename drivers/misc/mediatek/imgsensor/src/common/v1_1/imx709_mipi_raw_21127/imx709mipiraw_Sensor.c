...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX709_SENSOR_ID_21127,
            ...
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
            ...
            if (*sensor_id == IMX709_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(first_read){
                    read_module_data();
                    read_imx709_21127_LRC(imx709_LRC_setting);
                    read_imx709_21127_QSC(imx709_QSC_setting);
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx709_table_write_cmos_sensor(imx709_21127_seamless_normal_video, sizeof(imx709_21127_seamless_normal_video) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM4:
    {
        ...
        FMC_GPH_START;
        imx709_table_write_cmos_sensor(imx709_21127_seamless_custom4, sizeof(imx709_21127_seamless_custom4) / sizeof(kal_uint16));
        if (ae_ctrl) {
