...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40_SENSOR_ID_21690,
...
#endif
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gb,//[ITD]modify for 4cell sensor by wei.miao 20200609
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	{9248, 6944,  0,   0, 9248, 6944, 4624, 3472, 0, 0, 4624, 3468, 0, 0, 4624, 3468},	/*Preview*/
	{9248, 6944,  0,   0, 9248, 6944, 4624, 3472, 0, 0, 4624, 3468, 0, 0, 4624, 3468},	/*capture*/
	{9248, 6944,  0,   0, 9248, 6944, 4624, 3472, 0, 0, 4624, 2600, 0, 0, 4624, 2600},	/*normal video*/
	{9248, 6944,  0,   0, 9248, 6944, 2312, 1736, 0, 0, 2304, 1296, 0, 0, 2304, 1296},	/*hs video*/
	{9248, 6944,  0, 864, 9248, 5216, 4624, 2608, 0, 4, 4624, 2600, 0, 0, 4624, 2600},	/*slim video*/
	{9248, 6944,  0,   0, 9248, 6944, 4624, 3472, 0, 0, 4624, 3468, 0, 0, 4624, 3468},	/*custom1 60fps*/
	{9248, 6944,  768, 1312, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080},	/*custom2 dual_cam*/
	{9248, 6944,  0,   0, 9248, 6944, 9248, 6944, 0, 0, 9248, 6936, 0, 0, 9248, 6936},	/*custom3 Remosaic*/
	{9248, 6944,  0,   0, 9248, 6944, 2312, 1736, 0, 0, 2304, 1296, 0, 0, 2304, 1296},
	{9248, 6944,  0,   0, 9248, 6944, 4624, 3472, 0, 0, 4624, 3468, 0, 0, 4624, 3468},
};
...
{
        kal_uint16 addr_ovpd = 0x12CA, senaddr_ovpd = 0x5F80;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
					printk("ov64b40 i2c write id: 0x%x, sensor id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id);
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		...
		printk("ov64b40 get_imgsensor_id: 0x%x fail\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
...
//ITD:modify its sensorfusion fail by yuanhang.wang 20200717 start
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6000000;
    break;
