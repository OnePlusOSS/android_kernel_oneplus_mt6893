...
#define FOUR_CELL_QSC_START 0x0e00
#define FOUR_CELL_QSC_END 0x0fdf
#define FOUR_CELL_QSC_CHECKSUM 0x0fe1
#define FOUR_CELL_QSC_SIZE 480

#define DEVICE_VERSION_HI1634    "hi1634"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.normal_video = {
	  .pclk = 640000000,				//record different mode's pclk
		...
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width = 2304, 		//record different mode's width of grabwindow
		.grabwindow_height = 1300,		//record different mode's height of grabwindow
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
	...
	*/
	...
	.isp_driving_current = ISP_DRIVING_4MA, //ISP_DRIVING_4MA,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	{ 4672, 3520, 0, 28,  4672, 3464, 2336, 1732, 16,  2,  2304, 1728, 0, 0, 2304, 1728}, 	// preview (2304 x 1748)
	{ 4672, 3520, 0, 28,  4672, 3464, 2336, 1732, 16,  2,  2304, 1728, 0, 0, 2304, 1728}, 	// capture (2304 x 1748)
	{ 4672, 3520, 0, 456, 4672, 2608, 2336, 1304, 16,  2,  2304, 1300, 0, 0, 2304, 1300}, 	// video (1920 x 1080)
	{ 4672, 3520, 0, 676, 4672, 2168, 2336, 1084, 208, 2,  1920, 1080, 0, 0, 1920, 1080}, 	// hs video (1920 x 1080)
	{ 4672, 3520, 0, 676, 4672, 2168, 2336, 1084, 208, 2,  1920, 1080, 0, 0, 1920, 1080}, 	// slim video (1920 x 1080)
	{ 4672, 3520, 0, 6,   4672, 3508, 4672, 3508, 8,   2,  4656, 3504, 0, 0, 4656, 3504}, 	// costom1 (4656 x 3504)
	{ 4672, 3520, 0, 6,   4672, 3508, 4672, 3508, 8,   2,  4656, 3504, 0, 0, 4656, 3504}, 	// costom2 (4656 x 3504)
	{ 4672, 3520, 0, 6,   4672, 3508, 4672, 3508, 8,   2,  4656, 3504, 0, 0, 4656, 3504}, 	// costom3 (4656 x 3504) for remosaic
};
...
//	Max Framerate(fps)       : 	30.05
//	MIPI Speed(Mbps) x Lane  : 	848.00 x  4
//	MCLK(Mhz)                : 	24
//	Pixel Order              : 	GR
////////////////////////////////////////////
*/
...
static kal_uint16 hi1634q_custom1_setting[] = {
/*
////////////////////////////////////////////
//	Sensor                   : 	Hi-1634Q
//	Mode                     : 	QUAD_FULL
//	Image Size               : 	4656 x  3504
//	Max Framerate(fps)       : 	30.05
//	MIPI Speed(Mbps) x Lane  : 	1696.00 x  4
//	MCLK(Mhz)                : 	24
//	Pixel Order              : 	GR_QUAD
////////////////////////////////////////////
*/
...
static kal_uint16 hi1634q_custom2_setting[] = {
/*
////////////////////////////////////////////
//	Sensor                   : 	Hi-1634Q
//	Mode                     : 	QUAD_FULL
...
static kal_uint16 hi1634q_custom3_setting[] = {
/*
////////////////////////////////////////////
//	Sensor                   : 	Hi-1634Q
//	Mode                     : 	QUAD_FULL
...
{
	pr_debug("Hi-1634Q custom1_setting start\n");

	hi1634q_table_write_cmos_sensor(hi1634q_custom1_setting,
		sizeof(hi1634q_custom1_setting)/sizeof(kal_uint16));

	pr_debug("Hi-1634Q custom1_setting end\n");
}

/*full size 30fps*/
static void custom2_setting(void)
{
	pr_debug("Hi-1634Q custom2_setting start\n");

	hi1634q_table_write_cmos_sensor(hi1634q_custom2_setting,
		sizeof(hi1634q_custom2_setting)/sizeof(kal_uint16));

	pr_debug("Hi-1634Q custom2_setting end\n");
}
...
{
	pr_debug("Hi-1634Q custom3_setting start\n");

	hi1634q_table_write_cmos_sensor(hi1634q_custom3_setting,
		sizeof(hi1634q_custom3_setting)/sizeof(kal_uint16));

	pr_debug("Hi-1634Q custom3_setting end\n");
}
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_HI1634, imgsensor_info.module_id);
