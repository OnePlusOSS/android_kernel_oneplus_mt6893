...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_20817 - SENSOR_ID_OFFSET_20817,
...
static void read_module_data(void)
{
    ...
    gImgEepromInfo_20817.camNormdata[2][0] = Eeprom_1ByteDataRead(0x00, 0xA2);
    gImgEepromInfo_20817.camNormdata[2][1] = Eeprom_1ByteDataRead(0x01, 0xA2);
    gImgEepromInfo_20817.camNormdata[2][48] = 0xFF;
    gImgEepromInfo_20817.camNormdata[2][49] = 0xFF;
    ...
    for(i = 2; i < 8; i++) {
        gImgEepromInfo_20817.camNormdata[2][i] = Eeprom_1ByteDataRead(0x04+i, 0xA2);
        gImgEepromInfo_20817.camNormdata[2][i+48] = 0xFF;
    }

    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
        gImgEepromInfo_20817.camNormdata[2][8+i] = Eeprom_1ByteDataRead(0xB0+i, 0xA2);
    }
    ...
    memcpy(&gImgEepromInfo_20817.camNormdata[2][40], &vcmID, 4);
    memcpy(&gImgEepromInfo_20817.camNormdata[2][44], &lensID, 4);
    gImgEepromInfo_20817.camNormdata[2][39] = 2;
    /*Read stereo eeprom data*/
    for (i = 0; i < CALI_DATA_SLAVE_LENGTH; i ++) {
        gImgEepromInfo_20817.stereoMWdata[CALI_DATA_MASTER_LENGTH+i] =
                    Eeprom_1ByteDataRead(IMX355_STEREO_START_ADDR+i, 0xA2);
    }
    gImgEepromInfo_20817.i4CurSensorIdx = 2;
    gImgEepromInfo_20817.i4CurSensorId = IMX355_SENSOR_ID_20817;
