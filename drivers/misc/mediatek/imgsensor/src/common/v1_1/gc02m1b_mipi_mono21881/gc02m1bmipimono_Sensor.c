...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC02M1B_SENSOR_ID_21881 - SENSOR_ID_OFFSET_21881,        //record sensor id defined in Kd_imgsensor.h
...
#define I2C_BUFFER_LEN 510    /* trans# max is 255, each 3 bytes */
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
    static bool first_register = KAL_TRUE;
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                if (first_register) {
                    LOG_INF("register data when first poweron");
                    imgsensor_info.module_id = IMGSENSOR_MODULE_ID_SHINE;
                    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_21881.pCamModuleInfo[3].name,
                                        gImgEepromInfo_21881.pCamModuleInfo[3].version,
                                        imgsensor_info.module_id);
                    first_register = KAL_FALSE;
                }
