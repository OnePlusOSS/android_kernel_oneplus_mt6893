...
unsigned int read_imx766_20817_LRC(BYTE *data)
{
    static BYTE IMX766_20817_LRC_data[LRC_SIZE] = { 0 };
    ...
    if ((readed_size == 0) &&
        read_imx766_eeprom(pinfo->LRC_addr,
            IMX766_20817_LRC_data, pinfo->LRC_size)) {
        readed_size = pinfo->LRC_size;
    }
    mutex_unlock(&gimx766_eeprom_mutex);

    memcpy(data, IMX766_20817_LRC_data, pinfo->LRC_size);
    return readed_size;
}


unsigned int read_imx766_20817_DCC(BYTE *data)
{
