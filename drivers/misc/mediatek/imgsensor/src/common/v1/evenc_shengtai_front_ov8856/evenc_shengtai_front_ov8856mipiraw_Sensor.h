 ...
 * Filename:
 * ---------
 *	 EVENC_SHENGTAI_FRONT_OV8856mipi_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _EVENC_SHENGTAI_FRONT_OV8856MIPI_SENSOR_H
#define _EVENC_SHENGTAI_FRONT_OV8856MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1; /*slim video for VT scenario relative information*/
	struct imgsensor_mode_struct custom2; /*slim video for VT scenario relative information*/
	struct imgsensor_mode_struct custom3; /*slim video for VT scenario relative information*/
	...
	kal_uint8 i2c_addr_table[5]; /*record sensor support all write id addr, only
