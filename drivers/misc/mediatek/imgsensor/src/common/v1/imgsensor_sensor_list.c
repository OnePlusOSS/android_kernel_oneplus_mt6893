...
// #ifdef OPLUS_FEATURE_CAMERA_COMMON
	...
	{PASCALA_TRULY_MAIN_S5KGM1SP_SENSOR_ID, SENSOR_DRVNAME_PASCALA_TRULY_MAIN_S5KGM1SP,
		S5KGM1SP_TRULT_RAW_SensorInit},
#endif
#if defined(PASCALA_HLT_FRONT_S5K4H7)
	{PASCALA_HLT_FRONT_S5K4H7_SENSOR_ID, SENSOR_DRVNAME_PASCALA_HLT_FRONT_S5K4H7,
		PASCALA_HLT_FRONT_S5K4H7_MIPI_RAW_SensorInit},
#endif
#if defined(PASCALA_SHENGTAI_WIDE_OV8856)
    {PASCALA_SHENGTAI_WIDE_OV8856_SENSOR_ID, SENSOR_DRVNAME_PASCALA_SHENGTAI_WIDE_OV8856,
		PASCALA_SHENGTAI_WIDE_OV8856_SensorInit},
#endif
#if defined(PASCALA_SHENGTAI_MACRO_OV02B10)
	{PASCALA_SHENGTAI_MACRO_OV02B10_SENSOR_ID, SENSOR_DRVNAME_PASCALA_SHENGTAI_MACRO_OV02B10,
		PASCALA_SHENGTAI_MACRO_OV02B10_SensorInit},
#endif
// #endif
