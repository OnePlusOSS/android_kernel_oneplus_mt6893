...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC02M1B_SENSOR_ID_20817 - SENSOR_ID_OFFSET_20817,        //record sensor id defined in Kd_imgsensor.h
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                if (first_register) {
                    ...
                    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_20817.pCamModuleInfo[3].name,
                                        gImgEepromInfo_20817.pCamModuleInfo[3].version,
