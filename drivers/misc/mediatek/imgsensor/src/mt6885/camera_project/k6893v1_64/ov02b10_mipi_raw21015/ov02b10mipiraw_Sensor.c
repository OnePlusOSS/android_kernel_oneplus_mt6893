...
#define OV02B10_EEPROM_SLAVE_ADDRESS 0xA4
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static imgsensor_info_struct imgsensor_info = {

    /*record sensor id defined in Kd_imgsensor.h*/
    .sensor_id = OV02B10_SENSOR_ID_21015 - SENSOR_ID_OFFSET_21015,
...
static void read_module_data(void)
{
    ...
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][0] = Eeprom_1ByteDataRead(0x00, OV02B10_EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][1] = Eeprom_1ByteDataRead(0x01, OV02B10_EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][48] = 0xFF;
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][49] = 0xFF;
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, OV02B10_EEPROM_SLAVE_ADDRESS);
    ...
    for(i = 2; i < 8; i++) {
       gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][i] = Eeprom_1ByteDataRead(0x03+i, OV02B10_EEPROM_SLAVE_ADDRESS);
       gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][i+48] = 0xFF;
    }
    /*Read QR Code from eeprom: 8~27*/
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
       gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][8+i] = Eeprom_1ByteDataRead(0xE0+i, OV02B10_EEPROM_SLAVE_ADDRESS);
    }
    vcmID = Eeprom_1ByteDataRead(0x7, OV02B10_EEPROM_SLAVE_ADDRESS);
    lensID = Eeprom_1ByteDataRead(0x6, OV02B10_EEPROM_SLAVE_ADDRESS);
    memcpy(&gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][40], &vcmID, 4);
    memcpy(&gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][44], &lensID, 4);
