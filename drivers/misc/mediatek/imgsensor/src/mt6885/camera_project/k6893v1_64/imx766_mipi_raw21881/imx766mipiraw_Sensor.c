...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CUSTOM7:
    {
        ...
        if (ae_ctrl[GAIN_NE_FRM_1] >= ZOOM2X_AGAIN_1300_THRESHOLD) {
            ...
            imx766_table_write_cmos_sensor(imx766_21881_seamless_custom7_24x_again, sizeof(imx766_21881_seamless_custom7_24x_again) / sizeof(kal_uint16));
        } else if (ae_ctrl[GAIN_NE_FRM_1] >= ZOOM2X_AGAIN_700_THRESHOLD) {
            LOG_INF("optimize capture quality 16x again setting RegV4-3");
            imx766_table_write_cmos_sensor(imx766_21881_seamless_custom7_16x_again, sizeof(imx766_21881_seamless_custom7_16x_again) / sizeof(kal_uint16));
        } else if (ae_ctrl[GAIN_NE_FRM_1] >= ZOOM2X_AGAIN_350_THRESHOLD) {
            LOG_INF("optimize capture quality 8x again setting RegV4-3");
            imx766_table_write_cmos_sensor(imx766_21881_seamless_custom7_8x_again, sizeof(imx766_21881_seamless_custom7_8x_again) / sizeof(kal_uint16));
        } else if (ae_ctrl[GAIN_NE_FRM_1] >= ZOOM2X_AGAIN_150_THRESHOLD) {
            LOG_INF("optimize capture quality with 4x setting RegV4-3");
            imx766_table_write_cmos_sensor(imx766_21881_seamless_custom7_4x_again, sizeof(imx766_21881_seamless_custom7_4x_again) / sizeof(kal_uint16));
        } else {
            LOG_INF("optimize capture quality with 1x setting RegV4-3");
            imx766_table_write_cmos_sensor(imx766_21881_seamless_custom7_1x_again, sizeof(imx766_21881_seamless_custom7_1x_again) / sizeof(kal_uint16));
        }
        if (ae_ctrl) {
