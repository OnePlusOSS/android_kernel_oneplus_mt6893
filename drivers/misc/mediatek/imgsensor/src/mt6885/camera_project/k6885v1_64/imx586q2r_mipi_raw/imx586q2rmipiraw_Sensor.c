...
#include "imx586q2rmipiraw_Sensor.h"
#include "imx586q2r_eeprom.h"
...
#define PFX "IMX586Q2R_camera_sensor"
#define LOG_1 LOG_INF("IMX586Q2R,MIPI 4LANE\n")
/****************************   Modify end	**************************/
...
/*#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define DEVICE_VERSION_IMX586Q2R     "imx586q2r"
...
#if USE_BURST_MODE
static kal_uint16 imx586q2r_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len);
#endif
...
static void imx586q2r_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx586q2r_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void read_eeprom_SN(void)
{
	...
	for (idx = 0; idx <CAMERA_MODULE_SN_LENGTH; idx++) {
		char pusendcmd[2] = {0x00 , (char)((0xB0 + idx) & 0xFF) };
		iReadRegI2C(pusendcmd , 2, (u8*)&get_byte[idx],1, 0xA0);
		LOG_INF("imx586q2r_SN[%d]: 0x%x  0x%x\n", idx, get_byte[idx], gImx586_SN[idx]);
	}
}*/
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX586Q2R_SENSOR_ID)
				&& (data_base == 0x24D0)
				&& (data_length == 1561)) {
...
static kal_uint16 imx586q2r_QSC_setting[2304*2];
static kal_uint16 imx586q2r_LRC_setting[384*2];
static void read_sensor_Cali(void)
{
	...
	for (idx = 0; idx <2304; idx++) {
		...
		imx586q2r_QSC_setting[2*idx] = sensor_addr;
		imx586q2r_QSC_setting[2*idx + 1] = read_cmos_eeprom_8(addr_qsc);
	}

	for (idx = 0; idx < 192; idx++) {
		addr_lrc = 0x1620 + idx;
		sensor_addr = 0x7510 + idx;
		imx586q2r_LRC_setting[2*idx] = sensor_addr;
		imx586q2r_LRC_setting[2*idx + 1] = read_cmos_eeprom_8(addr_lrc);
	}
...
{
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_QSC_setting,
		sizeof(imx586q2r_QSC_setting)/sizeof(kal_uint16));
	#else
	kal_uint16 idx = 0, addr_qsc = 0x7F00;
	for (idx = 0; idx <2304; idx++) {
		addr_qsc = 0x7F00 + idx;
		write_cmos_sensor_8(addr_qsc, imx586q2r_QSC_setting[2*idx + 1]);
	}
	#endif
}
...
{
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_LRC_setting,
		sizeof(imx586q2r_LRC_setting)/sizeof(kal_uint16));
	#else
	kal_uint16 idx = 0, addr_lrc = 0x7510;
	for (idx = 0; idx <192; idx++) {
		addr_lrc = 0x7510 + idx;
		write_cmos_sensor_8(addr_lrc, imx586q2r_LRC_setting[2*idx + 1]);
	}
	for (idx = 192; idx < 384; idx++) {
...
static kal_uint32 imx586q2r_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	#if 0
	...
	imx586q2r_awb_gain_table[1]  = (grgain_32 >> 8) & 0xFF;
	imx586q2r_awb_gain_table[3]  = grgain_32 & 0xFF;
	imx586q2r_awb_gain_table[5]  = (rgain_32 >> 8) & 0xFF;
	imx586q2r_awb_gain_table[7]  = rgain_32 & 0xFF;
	imx586q2r_awb_gain_table[9]  = (bgain_32 >> 8) & 0xFF;
	imx586q2r_awb_gain_table[11] = bgain_32 & 0xFF;
	imx586q2r_awb_gain_table[13] = (gbgain_32 >> 8) & 0xFF;
	imx586q2r_awb_gain_table[15] = gbgain_32 & 0xFF;
	imx586q2r_table_write_cmos_sensor(imx586q2r_awb_gain_table,
		sizeof(imx586q2r_awb_gain_table)/sizeof(kal_uint16));
	#endif

	return ERROR_NONE;
}

static kal_uint16 imx586q2r_feedback_awbgain[] = {
	0x0b90, 0x00,
	0x0b91, 0x01,
	0x0b92, 0x00,
	0x0b93, 0x01,
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	#else
	imx586q2r_feedback_awbgain[1] = r_gain_int;
	imx586q2r_feedback_awbgain[3] = (((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
	imx586q2r_feedback_awbgain[5] = b_gain_int;
	imx586q2r_feedback_awbgain[7] = (((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
	imx586q2r_table_write_cmos_sensor(imx586q2r_feedback_awbgain,
		sizeof(imx586q2r_feedback_awbgain)/sizeof(kal_uint16));
	#endif
}

static void imx586q2r_set_lsc_reg_setting(
...
static kal_uint16 imx586q2r_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 imx586q2r_init_setting[] = {
...
//static kal_uint16 imx586q2r_capture_setting[] = {
static kal_uint16 imx586q2r_preview_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_normal_video_setting_4K60FPS[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_normal_video_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_hs_video_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_slim_video_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_custom3_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_custom4_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_custom5_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx586q2r_custom1_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static void sensor_init(void)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_init_setting,
		sizeof(imx586q2r_init_setting)/sizeof(kal_uint16));
	#else
	/*External Clock Setting*/
...
static void preview_setting(void)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_preview_setting,
		sizeof(imx586q2r_preview_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_capture_setting,
		sizeof(imx586q2r_capture_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_normal_video_setting,
		sizeof(imx586q2r_normal_video_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void hs_video_setting(void)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_hs_video_setting,
		sizeof(imx586q2r_hs_video_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void slim_video_setting(void)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_slim_video_setting,
		sizeof(imx586q2r_slim_video_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom3_setting(void)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_custom3_setting,
		sizeof(imx586q2r_custom3_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom4_setting(void)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_custom4_setting,
		sizeof(imx586q2r_custom4_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom5_setting(void)
{
	...
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_custom5_setting,
		sizeof(imx586q2r_custom5_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_custom1_setting,
		sizeof(imx586q2r_custom1_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom2_setting(void)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx586q2r_table_write_cmos_sensor(imx586q2r_normal_video_setting_4K60FPS,
		sizeof(imx586q2r_normal_video_setting_4K60FPS)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_MODULE_INFO:
		LOG_INF("imx586q2r GET_MODULE_CamInfo:%d %d\n", *feature_para_len, *feature_data_32);
	...
	case SENSOR_FEATURE_GET_MODULE_SN:
		LOG_INF("imx586q2r GET_MODULE_SN:%d %d\n", *feature_para_len, *feature_data_32);
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx586q2r_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx586q2r_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		imx586q2r_set_lsc_reg_setting(index, feature_data_16,
...
UINT32 IMX586Q2R_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* IMX586Q2R_MIPI_RAW_SensorInit */
