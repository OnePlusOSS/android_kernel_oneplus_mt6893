...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC02M1B_SENSOR_ID_ALICERT,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint16 addr_data_pair_init_carr_gc02m1b[] = {
/*system*/
0xfc,0x01,
0xf4,0x41,
0xf5,0xc0,
...
#if 0
static kal_uint16 addr_data_pair_preview_carr_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

static kal_uint16 addr_data_pair_capture_carr_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

static kal_uint16 addr_data_pair_normal_video_carr_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

static kal_uint16 addr_data_pair_hs_video_carr_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

static kal_uint16 addr_data_pair_slim_video_carr_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};
#endif
        ...
        while (imgsensor_info.i2c_addr_table[i] != 0xff) {
            ...
            do {
                *sensor_id = return_sensor_id();
                pr_info("read_cmos_value:0x%x",*sensor_id);
                if (*sensor_id == GC02M1B_SENSOR_ID) {
                    *sensor_id = imgsensor_info.sensor_id;
                    if(cnt == 0) {
                        Eeprom_DataInit(2, GC02M1B_SENSOR_ID_ALICERT);
                        cnt = 1;
                    }
