...
{
    kal_uint16 addr_ovpd = 0x0C9C, senaddr_ovpd = 0x5F80;
    kal_uint16 addr_crotalk = 0x19A0, senaddr_crotalk = 0x5A40;
    kal_uint16 i = 0;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
    printk("get_imgsensor_id enter ov64\n");
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        printk("get_imgsensor_id: 0x%x fail i2c write id: 0x%x \n", *sensor_id, imgsensor.i2c_write_id);
            ...
            UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    *(feature_data + 1) = imgsensor_info.min_shutter;
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = 2359000;
        break;
