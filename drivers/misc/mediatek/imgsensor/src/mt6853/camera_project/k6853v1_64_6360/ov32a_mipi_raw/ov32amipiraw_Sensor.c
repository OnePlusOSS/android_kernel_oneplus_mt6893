...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 6528, 4896,    0,    0, 6528, 4896, 3264, 2448, 0,    306, 3264, 1836,    0,    0, 3264, 1836},//custom5
};
...
{
    if (enable) {
        write_cmos_sensor(0x3019, 0xf0);//has been tested
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        //if (is_project(20392)) {
            //*(MINT32 *)(signed long)(*(feature_data + 1)) = -17150000;
        //} else {
            *(MINT32 *)(signed long)(*(feature_data + 1)) = 2479000;
        //}
        break;
