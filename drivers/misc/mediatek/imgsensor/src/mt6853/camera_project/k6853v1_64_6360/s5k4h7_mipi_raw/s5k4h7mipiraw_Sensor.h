...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom3; //custom1 scenario information
	struct imgsensor_mode_struct custom4; //custom1 scenario information
	struct imgsensor_mode_struct custom5; //custom1 scenario information
