...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID_MOSSA,
...
static kal_uint16 addr_data_pair_sw_init_gc02m1[] = {
...
static kal_uint16 addr_data_pair_sw_preview_gc02m1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_sw_capture_gc02m1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_sw_normal_video_gc02m1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_sw_hs_video_gc02m1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_sw_slim_video_gc02m1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			*sensor_id = (return_sensor_id()+0xa);
			if (*sensor_id == imgsensor_info.sensor_id) {
				imgsensor_info.module_id = 0x09;
				if (deviceInfo_register_value == 0x00) {
					//register_imgsensor_deviceinfo("Cam_r2", DEVICE_VERSION_GC02M1, imgsensor_info.module_id);
					deviceInfo_register_value = 0x01;
				}
				LOG_INF("gc02m1mossa i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			LOG_INF("gc02m1mossa Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
