...
#include "imx615mipiraw212a1_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX615_SENSOR_ID_212A1,
    ...
    .custom6 = { /* reg_C-2 3264x1856@60fps*/
        .pclk = 451200000,
        .linelength = 3768,
        .framelength = 1994,
        .startx = 0,
    ...
    .custom7 = { /* reg_C-2 3264x1856@60fps*/
        .pclk = 451200000,
        .linelength = 3768,
        .framelength = 1994,
        .startx = 0,
    ...
    .custom8 = { /* reg_C-2 3264x1856@60fps*/
        .pclk = 451200000,
        .linelength = 3768,
        .framelength = 1994,
        .startx = 0,
    ...
    .custom9 = { /* reg_C-2 3264x1856@60fps*/
        .pclk = 451200000,
        .linelength = 3768,
        .framelength = 1994,
        .startx = 0,
    ...
    .custom10 = { /* reg_C-2 3264x1856@60fps*/
        .pclk = 211200000,
        .linelength = 2248,
        .framelength = 9394,
        .startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[15] = {
    ...
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* custom6 */
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* custom7 */
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* custom8 */
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* custom9 */
    {6560, 4928, 0,   0, 6560, 4928, 1640, 1232,  8,   0, 1640, 1232,  0,  0, 1640, 1232}, /* custom10 */
};
...
static kal_uint16 imx615_custom6_setting[] = {
    //MIPI output setting
    0x0112,0x0A,
    0x0113,0x0A,
    0x0114,0x03,
...
static kal_uint16 imx615_custom7_setting[] = {
    //MIPI output setting
    0x0112,0x0A,
    0x0113,0x0A,
    0x0114,0x03,
...
static kal_uint16 imx615_custom8_setting[] = {
    //MIPI output setting
    0x0112,0x0A,
    0x0113,0x0A,
    0x0114,0x03,
...
static kal_uint16 imx615_custom9_setting[] = {
    //MIPI output setting
    0x0112,0x0A,
    0x0113,0x0A,
    0x0114,0x03,
...
static kal_uint16 imx615_custom10_setting[] = {
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
    0x0342, 0x08,
...
static void custom6_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx615_table_write_cmos_sensor(imx615_custom6_setting,
        sizeof(imx615_custom6_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom7_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx615_table_write_cmos_sensor(imx615_custom7_setting,
        sizeof(imx615_custom7_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom8_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx615_table_write_cmos_sensor(imx615_custom8_setting,
        sizeof(imx615_custom8_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom9_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx615_table_write_cmos_sensor(imx615_custom9_setting,
        sizeof(imx615_custom9_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
...
static void custom10_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx615_table_write_cmos_sensor(imx615_custom10_setting,
        sizeof(imx615_custom10_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = -27701333;
        LOG_INF("exporsure");
    break;
