 ...
 *
 ****************************************************************************/
#ifndef _IMX615MIPI_SENSOR_H
#define _IMX615MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	kal_uint8 custom6_delay_frame; /* enter custom1 delay frame num */
	kal_uint8 custom7_delay_frame; /* enter custom2 delay frame num */
	kal_uint8 custom8_delay_frame; /* enter custom3 delay frame num */
	kal_uint8 custom9_delay_frame; /* enter custom4 delay frame num */
	kal_uint8 custom10_delay_frame; /* enter custom4 delay frame num */
