...
static imgsensor_info_struct imgsensor_info = {
       ...
       .hs_video = {
        ...
        .i2c_addr_table = {0x6f,0x6e,0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
        .i2c_speed = 400,
};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    LOG_INF("gc02m0_mipi_mono1_Sensor I2C_BUS = %d\n", I2C_BUS);
    if(I2C_BUS != 8){
        ...
        do {
            *sensor_id = return_sensor_id()+1;
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                Oplusimgsensor_Registdeviceinfo(gImgEepromInfo.pCamModuleInfo[4].name,
