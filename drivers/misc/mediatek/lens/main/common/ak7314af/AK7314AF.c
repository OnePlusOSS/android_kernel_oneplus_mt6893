...
#define AF_DRVNAME "AK7314AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long AK7314AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int AK7314AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int AK7314AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
            int *pAF_Opened)
{
...
int AK7314AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int AK7314AF_GetFileName(unsigned char *pFileName)
{
...
int AK7314AF_DoExtLdo(int enable)
{
    LOG_INF("AK7314AF_DoExtLdo enable: %d", enable);
    if(enable) {
