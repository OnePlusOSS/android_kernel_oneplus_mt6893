...
#define OPLUS_SIGN_XL_AUO_FW_PATH        "/tp/19741/xl_auo_ilitek_oplus_signed.bin"
#define OPLUS_FIRMWARE_XL_AUO_NAME_PATH	"tp/19741/xl_auo_ilitek_oplus_signed.bin"
...
#define OPLUS_SIGN_TXD_AUO_FW_PATH       "/tp/19741/txd_auo_ilitek_oplus_signed.bin"
#define OPLUS_FIRMWARE_TXD_AUO_NAME_PATH	"tp/19741/txd_auo_ilitek_oplus_signed.bin"
...
#define oplus_debug(level, fmt, arg...)					\
	do {									\
		if (level == oplus_debug_level)					\
		pr_info("[TP]OPLUS[DEBUG]: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
	} while (0)
...
extern int oplus_proc_init(void);
