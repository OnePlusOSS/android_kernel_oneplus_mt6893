...
static void bq27541_hw_config(struct chip_bq27541 *chip)
{
	...
	if (device_type == DEVICE_TYPE_BQ27411) {
		...
		chip->device_type_for_wrap = DEVICE_TYPE_FOR_WRAP_BQ27411;
	} else if (device_type == DEVICE_TYPE_ZY0602) {
		chip->device_type = DEVICE_ZY0602;
		chip->device_type_for_wrap = DEVICE_TYPE_FOR_WRAP_BQ27541;
	} else {
...
*/
	...
	chip->device_type_for_wrap = gauge_ic->device_type_for_wrap;
