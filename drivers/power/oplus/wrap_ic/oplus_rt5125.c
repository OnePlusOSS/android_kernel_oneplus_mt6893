...
static int rt5125_i2c_block_read(struct oplus_wrap_chip *chip, u8 cmd, u8 * data, s32 len)
{
	u8 crc;
	int retry = 0, ret;
...
static int rt5125_i2c_block_write(struct oplus_wrap_chip *chip, u8 cmd, const u8 * data, s32 len)
{
	int retry = 0, ret;
...
static int rt5125_fw_update(struct oplus_wrap_chip *chip)
{
...
static bool rt5125_fw_update_check(struct oplus_wrap_chip *chip)
{
	const u8 *data = chip->firmware_data;
	s32 len = chip->fw_data_count;
...
/******************************************************************/
static int rt5125_get_fw_verion_from_ic(struct oplus_wrap_chip *chip)
{
...
static int rt5125_fw_check_then_recover(struct oplus_wrap_chip *chip)
{
	int update_result = 0;
	int try_count = 5;
	int ret = 0;
...
void rt5125_update_temperature_soc(void)
{
	...
	if (!the_chip->wrap_is_platform_gauge){
		chg_err("not support platform gauge wrap\n");
		return;
	}
...
void rt5125_set_reset_active(struct oplus_wrap_chip *chip)
{
	the_bat.uv_bat = 0;
	the_bat.current_bat = 0;
	opchg_set_reset_active(chip);
...
void rt5125_set_reset_sleep(struct oplus_wrap_chip *chip)
{
	the_bat.uv_bat = 0;
	the_bat.current_bat = 0;
	opchg_set_reset_sleep(chip);
...
struct oplus_wrap_operations oplus_rt5125_ops = {
...
static int rt5125_parse_fw_from_dt(struct oplus_wrap_chip *chip)
{
...
static int rt5125_parse_fw_from_array(struct oplus_wrap_chip *chip)
{
	...
	if (chip->wrap_fw_type == WRAP_FW_TYPE_RT5125_4450_WRAP_FFC_15C) {
		chip->firmware_data = rt5125_fw;
		chip->fw_data_count = sizeof(rt5125_fw);
		chip->fw_data_version = rt5125_fw[chip->fw_data_count - 4];
	} else if (chip->wrap_fw_type == WRAP_FW_TYPE_RT5125_4450_WRAP_FFC_5V6A_7BIT) {
		chip->firmware_data = rt5125_fw_data_4450_wrap_ffc_5v6a_7bit;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_wrap_ffc_5v6a_7bit);
		chip->fw_data_version = rt5125_fw_data_4450_wrap_ffc_5v6a_7bit[chip->fw_data_count - 4];
	} else if (chip->wrap_fw_type == WRAP_FW_TYPE_RT5125_4450_WRAP_FFC_10V5A_7BIT) {
		chip->firmware_data = rt5125_fw_data_4450_wrap_ffc_10v5a_7bit;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_wrap_ffc_10v5a_7bit);
		chip->fw_data_version = rt5125_fw_data_4450_wrap_ffc_10v5a_7bit[chip->fw_data_count - 4];
	} else if (chip->wrap_fw_type == WRAP_FW_TYPE_RT5125_4450_WRAP_FFC_10V6P5A_7BIT) {
		chip->firmware_data = rt5125_fw_data_4450_wrap_ffc_10v6p5a_7bit;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_wrap_ffc_10v6p5a_7bit);
		chip->fw_data_version = rt5125_fw_data_4450_wrap_ffc_10v6p5a_7bit[chip->fw_data_count - 4];
	} else if (chip->wrap_fw_type == WRAP_FW_TYPE_RT5125_4450_WRAP_FFC_10V6P5A_7BIT_JIN) {
		chip->firmware_data = rt5125_fw_data_4450_wrap_ffc_10v6p5a_7bit_jin;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_wrap_ffc_10v6p5a_7bit_jin);
		chip->fw_data_version = rt5125_fw_data_4450_wrap_ffc_10v6p5a_7bit_jin[chip->fw_data_count - 4];
	} else if (chip->wrap_fw_type == WRAP_FW_TYPE_RT5125_4500_WRAP_FFC_10V6P5A_7BIT_20817) {
		chip->firmware_data = rt5125_fw_data_4500_swrap_ffc_6500ma_7bit_20817;
		chip->fw_data_count = sizeof(rt5125_fw_data_4500_swrap_ffc_6500ma_7bit_20817);
		chip->fw_data_version = rt5125_fw_data_4500_swrap_ffc_6500ma_7bit_20817[chip->fw_data_count - 4];
	}
...
static int rt5125_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
#endif
	if (get_wrap_mcu_type(chip) != OPLUS_WRAP_ASIC_HWID_RT5125) {
	...
	if (chip->wrap_is_platform_gauge) {
...
MODULE_DESCRIPTION("Driver for oplus wrap rt5125 fast mcu");
