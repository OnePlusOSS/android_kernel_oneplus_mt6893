...
enum NORMAL_TEMP_REGION_TYPE {
	...
	NORMAL_TEMP_REGION1,/*12~39C*/
	NORMAL_TEMP_REGION2,/*39~42C*/
	NORMAL_TEMP_REGION3,/*42~45C*/
};
...
struct wpc_chg_param_t{
	...
	int wrap_iout_ma;
	int swrap_input_ma;
	int swrap_65w_iout_ma;
	int swrap_50w_iout_ma;
	int bpp_temp_cold_fastchg_ma;						// -2
	int wrap_temp_little_cold_fastchg_ma;		// 0
	int swrap_temp_little_cold_iout_ma;
	int swrap_temp_little_cold_fastchg_ma;
	int bpp_temp_little_cold_fastchg_ma;
	int epp_temp_little_cold_fastchg_ma;
	int epp_15w_temp_little_cold_fastchg_ma;
	int wrap_temp_cool_fastchg_ma;				// 5
	int swrap_temp_cool_iout_ma;
	int swrap_temp_cool_fastchg_ma;
	int bpp_temp_cool_fastchg_ma;
	int epp_temp_cool_fastchg_ma;
	int epp_15w_temp_cool_fastchg_ma;
	int wrap_temp_little_cool_fastchg_ma;		// 12
	int swrap_temp_little_cool_fastchg_ma;
	int bpp_temp_little_cool_fastchg_ma;
	int epp_temp_little_cool_fastchg_ma;
	int epp_15w_temp_little_cool_fastchg_ma;
	int wrap_temp_normal_fastchg_ma;		// 16
	int swrap_temp_normal_fastchg_ma;
	int bpp_temp_normal_fastchg_ma;
	int epp_temp_normal_fastchg_ma;
	int epp_15w_temp_normal_fastchg_ma;
	int wrap_temp_warm_fastchg_ma;		// 45
	int swrap_temp_warm_fastchg_ma;
