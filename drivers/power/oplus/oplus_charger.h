...
#define SMART_WRAP_CHARGER_CURRENT_BIT0 	0X01
#define SMART_WRAP_CHARGER_CURRENT_BIT1 	0X02
#define SMART_WRAP_CHARGER_CURRENT_BIT2 	0X04
#define SMART_WRAP_CHARGER_CURRENT_BIT3 	0X08
#define SMART_WRAP_CHARGER_CURRENT_BIT4 	0X10
#define SMART_WRAP_CHARGER_CURRENT_BIT5 	0X20
#define SMART_WRAP_CHARGER_CURRENT_BIT6 	0X40
#define SMART_WRAP_CHARGER_CURRENT_BIT7 	0X80

#define SMART_COMPATIBLE_WRAP_CHARGER_CURRENT_BIT0 	0X100
#define SMART_COMPATIBLE_WRAP_CHARGER_CURRENT_BIT1 	0X200
#define SMART_COMPATIBLE_WRAP_CHARGER_CURRENT_BIT2 	0X400
...
typedef enum {
	...
	CRITICAL_LOG_WRAP_WATCHDOG,
	CRITICAL_LOG_WRAP_BAD_CONNECTED,
	CRITICAL_LOG_WRAP_BTB,
	CRITICAL_LOG_WRAP_FW_UPDATE_ERR,
...
typedef enum {
	...
	CHARGER_SUBTYPE_FASTCHG_SWRAP,
	CHARGER_SUBTYPE_PD,
	CHARGER_SUBTYPE_QC,
}OPLUS_CHARGER_SUBTYPE;

typedef enum {
	WRAP_TEMP_STATUS__NORMAL = 0,	/*<=34c*/
	WRAP_TEMP_STATUS__WARM,			/*>34 && <=38C*/
	WRAP_TEMP_STATUS__HIGH,			/*>38 && <=45C*/
}OPLUS_CHG_TBAT_WRAP_STATUS;
...
struct oplus_chg_limits {
	...
	int input_current_wrap_led_ma_high;
	int input_current_wrap_led_ma_warm;
	int input_current_wrap_led_ma_normal;
	int wrap_high_bat_decidegc;						/*>=45C*/
	int input_current_wrap_ma_high;
	int default_input_current_wrap_ma_high;
	int wrap_warm_bat_decidegc;						/*38C*/
	int wrap_warm_bat_decidegc_antishake;			/*38C*/
	int input_current_wrap_ma_warm;
	int default_input_current_wrap_ma_warm;
	int wrap_normal_bat_decidegc;					/*34C*/
	int wrap_normal_bat_decidegc_antishake;
	int input_current_wrap_ma_normal;				/*<34c*/
	int default_input_current_wrap_ma_normal;
	int charger_current_wrap_ma_normal;
	int iterm_ma;
	bool iterm_disabled;
	int recharge_mv;
...
/*	struct battery_data battery_main	*/
	...
	int led_temp_status;
	bool wrap_temp_change;
	int wrap_temp_status;
	bool camera_on;
	bool calling_on;
	bool ac_online;
	bool cool_down_done;
	...
	bool chg_ctrl_by_wrap;
	bool chg_ctrl_by_wrap_default;
	bool fg_bcl_poll;
	bool chg_powersave;
	bool healthd_ready;
#ifdef CONFIG_FB
	...
	bool wrap_show_ui_soc_decimal;
	struct thermal_zone_device *shell_themal;
	int swrap_disconnect_count;
	int detect_detach_unexpeactly;
	unsigned long long swrap_detect_time;
	unsigned long long swrap_detach_time;
...
struct oplus_chg_operations {
	...
	int (*input_current_ctrl_by_wrap_write)(int cur);
