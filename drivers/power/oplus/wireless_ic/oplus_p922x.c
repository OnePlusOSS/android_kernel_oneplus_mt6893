...
static int oplus_wpc_chg_parse_chg_dt(struct oplus_p922x_ic *chip)
{
	...
	rc = of_property_read_u32(node, "qcom,wrap_input_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_input_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_input_ma = 1000;
	}
	chg_err("wrap_input_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_input_ma);

	rc = of_property_read_u32(node, "qcom,wrap_iout_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_iout_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_iout_ma = 1000;
	}
	chg_err("wrap_iout_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_input_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_input_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_input_ma = 1000;
	}
	chg_err("swrap_input_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.swrap_input_ma);

	rc = of_property_read_u32(node, "qcom,swrap_65w_iout_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_65w_iout_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_65w_iout_ma = 2000;
	}
	chg_err("swrap_65w_iout_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.swrap_65w_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_50w_iout_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_50w_iout_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_50w_iout_ma = 1750;
	}
	...
	rc = of_property_read_u32(node, "qcom,wrap_temp_little_cold_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma = 1200;
	}
	chg_err("wrap_temp_little_cold_fastchg_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_little_cold_iout_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_iout_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_iout_ma = 650;
	}
	chg_err("swrap_temp_little_cold_iout_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_little_cold_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma = 1200;
	}
	...
	rc = of_property_read_u32(node, "qcom,wrap_temp_cool_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma = 1200;
	}
	chg_err("wrap_temp_cool_fastchg_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_cool_iout_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_iout_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_iout_ma = 650;
	}
	chg_err("swrap_temp_cool_iout_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_cool_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma = 1200;
	}
	...
	rc = of_property_read_u32(node, "qcom,wrap_temp_little_cool_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma = 1200;
	}
	chg_err("wrap_temp_little_cool_fastchg_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_little_cool_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma = 1200;
	}
	...
	rc = of_property_read_u32(node, "qcom,wrap_temp_normal_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma = 1200;
	}
	chg_err("wrap_temp_normal_fastchg_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_normal_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_normal_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_normal_fastchg_ma = 1200;
	}
	...
	rc = of_property_read_u32(node, "qcom,wrap_temp_warm_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.wrap_temp_warm_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.wrap_temp_warm_fastchg_ma = 1200;
	}
	chg_err("wrap_temp_warm_fastchg_ma[%d]\n", chip->p922x_chg_status.wpc_chg_param.wrap_temp_warm_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_warm_fastchg_ma",
			&chip->p922x_chg_status.wpc_chg_param.swrap_temp_warm_fastchg_ma);
	if (rc) {
		chip->p922x_chg_status.wpc_chg_param.swrap_temp_warm_fastchg_ma = 1200;
	}
...
static bool oplus_wpc_get_fastchg_allow(struct oplus_p922x_ic *chip)
{
	...
	if(chip->p922x_chg_status.adapter_type != ADAPTER_TYPE_WRAP
		&& chip->p922x_chg_status.adapter_type != ADAPTER_TYPE_SWRAP
		&& chip->p922x_chg_status.adapter_type != ADAPTER_TYPE_SWRAP_50W){
...
int p922x_charge_set_max_current_by_tbatt(struct oplus_p922x_ic *chip)
{
	...
	switch (now_tbatt) {
		case BATTERY_STATUS__NORMAL:
			chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_65w_iout_ma;
			...
			case ADAPTER_TYPE_WRAP:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma;
				break;
			case ADAPTER_TYPE_SWRAP:
				charging_current = chip->p922x_chg_status.wpc_chg_param.swrap_65w_iout_ma;
				break;
			case ADAPTER_TYPE_SWRAP_50W:
				charging_current = chip->p922x_chg_status.wpc_chg_param.swrap_50w_iout_ma;
				break;
		...
		case BATTERY_STATUS__LITTLE_COLD_TEMP:
			...
			switch (chip->p922x_chg_status.adapter_type){
			case ADAPTER_TYPE_WRAP:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma;
				break;
			case ADAPTER_TYPE_SWRAP:
			case ADAPTER_TYPE_SWRAP_50W:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma;
				break;
			case ADAPTER_TYPE_EPP:
		...
		case BATTERY_STATUS__COOL_TEMP:
			...
			switch (chip->p922x_chg_status.adapter_type){
			case ADAPTER_TYPE_WRAP:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma;
				break;
			case ADAPTER_TYPE_SWRAP:
			case ADAPTER_TYPE_SWRAP_50W:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma;
				break;
			case ADAPTER_TYPE_EPP:
		...
		case BATTERY_STATUS__LITTLE_COOL_TEMP:
			...
			switch (chip->p922x_chg_status.adapter_type){
			case ADAPTER_TYPE_WRAP:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma;
				break;
			case ADAPTER_TYPE_SWRAP:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_65w_iout_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma;
				break;
			case ADAPTER_TYPE_SWRAP_50W:
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_50w_iout_ma;
				charging_current = chip->p922x_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma;
				break;
			case ADAPTER_TYPE_EPP:
...
static int oplus_wpc_set_input_current(struct oplus_p922x_ic *chip)
{
	...
	switch (chip->p922x_chg_status.adapter_type) {
		case ADAPTER_TYPE_WRAP:
			current_limit = chip->p922x_chg_status.wpc_chg_param.wrap_input_ma;
			break;
		case ADAPTER_TYPE_SWRAP:
			current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_input_ma;
			break;
		case ADAPTER_TYPE_SWRAP_50W:
			current_limit = chip->p922x_chg_status.wpc_chg_param.swrap_input_ma;
			break;
...
int p922x_charge_set_max_current_by_adapter_power(struct oplus_p922x_ic *chip)
{
	switch (chip->p922x_chg_status.adapter_power){
		...
		case ADAPTER_POWER_20W:
			if(chip->p922x_chg_status.fastchg_current_limit > chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma)
				chip->p922x_chg_status.fastchg_current_limit = chip->p922x_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma;
			break;
		default:
			break;
...
#ifdef FASTCHG_TEST_BY_TIME
		if ( chip->p922x_chg_status.adapter_type == ADAPTER_TYPE_SWRAP) {
	...
	case WPC_CHG_STATUS_CHARGEPUMP_INIT:
		...
		if (chargepump_check_dwp_status() == -1) {
			...
			if ((chip->p922x_chg_status.vout >= 19000)
				...
				chip->p922x_chg_status.adapter_type = ADAPTER_TYPE_WRAP;
				chip->p922x_chg_status.charge_status = WPC_CHG_STATUS_CHARGER_FASTCHG_INIT;
				break;
			} else {
...
static int p922x_wpc_get_online_status(void)
{
	struct oplus_p922x_ic *chip = p922x_chip;
	int online = 0;
	...
	online = chip->p922x_chg_status.charge_online;
	if (online == 0 && p922x_get_self_reset())
		online = 1;
...
static int p922x_wpc_get_voltage_now(void)
{
	struct oplus_p922x_ic *chip = p922x_chip;
	int voltage_now = 0;
	...
	voltage_now = p922x_wireless_get_vout();

	return voltage_now;
}

static int p922x_wpc_get_current_now(void)
{
	struct oplus_p922x_ic *chip = p922x_chip;
	int current_now = 0;
	...
	current_now = chip->p922x_chg_status.iout;

	return current_now;
}

static int p922x_wpc_get_real_type(void)
{
	struct oplus_p922x_ic *chip = p922x_chip;
	int real_type = 0;
...
struct oplus_wpc_operations p922x_ops = {
	.wpc_get_online_status = p922x_wpc_get_online_status,
	.wpc_get_voltage_now = p922x_wpc_get_voltage_now,
	.wpc_get_current_now = p922x_wpc_get_current_now,
	.wpc_get_real_type = p922x_wpc_get_real_type,
