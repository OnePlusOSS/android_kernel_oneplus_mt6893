...
static struct target_ichg_table swrap_table[] = {
...
static struct target_ichg_table wrap_table[] = {
	{5000, 1200, 950}, {5000, 500, 400}, {5000, 400, 300}, {5000, 200, 300},
	{0, 0, 0},
};
...
5V_en[%d], EXT2_otg_en[%d], EXT1_otg_en[%d], internal_5V_ldo_en[%d],charge_online[%d]\n",
...
[Batt vol max: %d] [Batt vol min: %d] [Term Vol: %d] [Term Curr: %d]\n",
	...
	chg_err("<~WPC~> nu1619 Temperature = %d\n", nu1619_get_rx_temperature());
}
...
static int oplus_wpc_chg_parse_chg_dt(struct oplus_nu1619_ic *chip)
{
	...
	chg_err("wrap_iout_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.wrap_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_input_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_input_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_input_ma = 1000;
	}
	chg_err("swrap_input_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_input_ma);

	rc = of_property_read_u32(node, "qcom,swrap_65w_iout_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_65w_iout_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_65w_iout_ma = 2000;
	}
	chg_err("swrap_65w_iout_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_65w_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_50w_iout_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma = 1750;
	}
	chg_err("swrap_50w_iout_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma);
	...
	chg_err("wrap_temp_little_cold_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_little_cold_iout_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_iout_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_iout_ma = 650;
	}
	chg_err("swrap_temp_little_cold_iout_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_little_cold_fastchg_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma = 1200;
	}
	chg_err("swrap_temp_little_cold_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma);
	...
	chg_err("wrap_temp_cool_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_cool_iout_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_iout_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_iout_ma = 650;
	}
	chg_err("swrap_temp_cool_iout_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_iout_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_cool_fastchg_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma = 1200;
	}
	chg_err("swrap_temp_cool_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma);
	...
	chg_err("wrap_temp_little_cool_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_little_cool_fastchg_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma = 1200;
	}
	chg_err("swrap_temp_little_cool_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma);
	...
	chg_err("wrap_temp_normal_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_normal_fastchg_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_normal_fastchg_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_normal_fastchg_ma = 1200;
	}
	chg_err("swrap_temp_normal_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_normal_fastchg_ma);
	...
	chg_err("wrap_temp_warm_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.wrap_temp_warm_fastchg_ma);

	rc = of_property_read_u32(node, "qcom,swrap_temp_warm_fastchg_ma",
			&chip->nu1619_chg_status.wpc_chg_param.swrap_temp_warm_fastchg_ma);
	if (rc) {
		chip->nu1619_chg_status.wpc_chg_param.swrap_temp_warm_fastchg_ma = 1200;
	}
	chg_err("swrap_temp_warm_fastchg_ma[%d]\n", chip->nu1619_chg_status.wpc_chg_param.swrap_temp_warm_fastchg_ma);
...
static bool oplus_wpc_get_fastchg_allow(struct oplus_nu1619_ic *chip)
{
	...
	if(chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_WRAP
		&& chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_SWRAP
		&& chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_SWRAP_50W) {
...
*/
	...
	if ((chip->nu1619_chg_status.adapter_type == ADAPTER_TYPE_SWRAP_50W
			|| chip->nu1619_chg_status.adapter_type == ADAPTER_TYPE_SWRAP)
			&& (temp < -20 || temp > 530)) {
		chip->nu1619_chg_status.fastchg_allow = false;
		return chip->nu1619_chg_status.fastchg_allow;
...
static void nu1619_charge_check_ffc_status(struct oplus_nu1619_ic *chip)
{
	...
	if (chip->nu1619_chg_status.wpc_ffc_charge == true) {
		...
		if ((chip->nu1619_chg_status.fastcharge_level <= FASTCHARGE_LEVEL_5
				&& g_oplus_chip->batt_volt > 4370 && (-1 * g_oplus_chip->icharging) < 800)
				|| (chip->nu1619_chg_status.fastcharge_level == FASTCHARGE_LEVEL_7
				&& g_oplus_chip->batt_volt > 4370 && (-1 * g_oplus_chip->icharging) < 600)
				|| (chip->nu1619_chg_status.fastcharge_level == FASTCHARGE_LEVEL_8
				&& g_oplus_chip->batt_volt > 4370 && (-1 * g_oplus_chip->icharging) < 400)
				|| (chip->nu1619_chg_status.fastcharge_level == FASTCHARGE_LEVEL_10
				&& g_oplus_chip->batt_volt > 4370 && (-1 * g_oplus_chip->icharging) < 200)) {
...
static int nu1619_charge_get_ffc_input_current(struct oplus_nu1619_ic *chip)
{
	...
	if (chip->nu1619_chg_status.wpc_ffc_charge == true) {
		...
		if (non_ffc_level == FASTCHARGE_LEVEL_UNKNOW) {
			...
			if (pre_adapter_type == ADAPTER_TYPE_SWRAP_50W
					|| pre_adapter_type == ADAPTER_TYPE_SWRAP)
				non_ffc_level = FASTCHARGE_LEVEL_1;
			else if (pre_adapter_type == ADAPTER_TYPE_WRAP)
	...
	if (chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_SWRAP_50W
			&& chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_SWRAP
			&& chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_WRAP
...
static int nu1619_charge_get_cv_target_ichg(struct oplus_nu1619_ic *chip)
{
	...
	case ADAPTER_TYPE_SWRAP:
	case ADAPTER_TYPE_SWRAP_50W:
		cv_target_ichg = FASTCHG_CUR_CV;
		break;
	case ADAPTER_TYPE_WRAP:
...
static int nu1916_charge_get_cool_down_target_ichg(struct oplus_nu1619_ic *chip)
{
	...
	if (g_oplus_chip->led_on == false)
		return 0;

	switch (chip->nu1619_chg_status.adapter_type) {
	case ADAPTER_TYPE_SWRAP:
	case ADAPTER_TYPE_SWRAP_50W:
		if (cool_down >= ARRAY_SIZE(cool_down_swrap)
				&& ARRAY_SIZE(cool_down_swrap) > 1)
			cool_down = ARRAY_SIZE(cool_down_swrap) - 1;
		cool_down_target_ichg = cool_down_swrap[cool_down];
		break;
	case ADAPTER_TYPE_WRAP:
		if (cool_down >= ARRAY_SIZE(cool_down_wrap)
				&& ARRAY_SIZE(cool_down_wrap) > 1)
			cool_down = ARRAY_SIZE(cool_down_wrap) - 1;
		cool_down_target_ichg = cool_down_wrap[cool_down];
		break;
	case ADAPTER_TYPE_EPP:
		if (chip->nu1619_chg_status.rx_runing_mode == RX_RUNNING_MODE_EPP_15W) {
...
{
	if (chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_SWRAP
			&& chip->nu1619_chg_status.adapter_type != ADAPTER_TYPE_SWRAP_50W)
		return false;
	...
	if (oplus_chg_get_tbatt_status() == BATTERY_STATUS__COLD_TEMP
			...
			|| chip->nu1619_chg_status.work_silent_mode == true
			|| (g_oplus_chip->led_on == true
			&& g_oplus_chip->cool_down > 0
			&& g_oplus_chip->cool_down <= COOL_DOWN_12V_THR))
		return true;
	else
		return false;
}
...
static void nu1619_charge_set_target_ichg(struct oplus_nu1619_ic *chip)
{
	...
	case BATTERY_STATUS__LITTLE_COLD_TEMP:
		...
		case ADAPTER_TYPE_EPP:
			...
			/*if (chip->nu1619_chg_status.rx_runing_mode == RX_RUNNING_MODE_EPP_8W)
				input_current = chip->nu1619_chg_status.wpc_chg_param.epp_8w_input_ma;*/
			break;
		default:
	...
	case ADAPTER_TYPE_SWRAP:
	case ADAPTER_TYPE_SWRAP_50W:
		target_ichg_to_input_current(vbatt, target_ichg, swrap_table, i, input_current);
		break;
	case ADAPTER_TYPE_WRAP:
		target_ichg_to_input_current(vbatt, target_ichg, wrap_table, i, input_current);
		break;
	case ADAPTER_TYPE_EPP:
		target_ichg_to_input_current(vbatt, target_ichg, epp_table, i, input_current);
		break;
	...
	chg_err("<~WPC~> t_iin-iout[%d-%d]: t-cool-cv_ichg[%d-%d-%d], input[%d]; %sffc_ichg[%d], %sffc_input[%d]; vbatt[%d]\n",
		...
		fasctchg_current[chip->nu1619_chg_status.fastcharge_level], (chip->nu1619_chg_status.wpc_ffc_charge == true) ? "" : "non-",
		ffc_input_current, vbatt);
}
...
int nu1619_charge_set_max_current_by_tbatt(struct oplus_nu1619_ic *chip)
{
	...
	case BATTERY_STATUS__NORMAL:
		chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_65w_iout_ma;
		...
		switch (chip->nu1619_chg_status.adapter_type) {
		case ADAPTER_TYPE_WRAP:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma;
			...
			break;
		case ADAPTER_TYPE_SWRAP:
			charging_current = chip->nu1619_chg_status.wpc_chg_param.swrap_65w_iout_ma;
			break;
		case ADAPTER_TYPE_SWRAP_50W:
			charging_current = chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma;
			break;
		case ADAPTER_TYPE_EPP:
	...
	case BATTERY_STATUS__LITTLE_COLD_TEMP:
		...
		switch (chip->nu1619_chg_status.adapter_type) {
		case ADAPTER_TYPE_WRAP:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_little_cold_fastchg_ma;
			break;
		case ADAPTER_TYPE_SWRAP:
		case ADAPTER_TYPE_SWRAP_50W:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cold_fastchg_ma;
			break;
		case ADAPTER_TYPE_EPP:
	...
	case BATTERY_STATUS__COOL_TEMP:
		...
		switch (chip->nu1619_chg_status.adapter_type) {
		case ADAPTER_TYPE_WRAP:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_cool_fastchg_ma;
			break;
		case ADAPTER_TYPE_SWRAP:
		case ADAPTER_TYPE_SWRAP_50W:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.swrap_temp_cool_fastchg_ma;
			break;
		case ADAPTER_TYPE_EPP:
	...
	case BATTERY_STATUS__LITTLE_COOL_TEMP:
		...
		switch (chip->nu1619_chg_status.adapter_type) {
		case ADAPTER_TYPE_WRAP:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_little_cool_fastchg_ma;
			break;
		case ADAPTER_TYPE_SWRAP:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_65w_iout_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma;
			break;
		case ADAPTER_TYPE_SWRAP_50W:
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma;
			charging_current = chip->nu1619_chg_status.wpc_chg_param.swrap_temp_little_cool_fastchg_ma;
			break;
		case ADAPTER_TYPE_EPP:
...
static int oplus_wpc_set_input_current(struct oplus_nu1619_ic *chip)
{
	...
	switch (chip->nu1619_chg_status.adapter_type) {
	case ADAPTER_TYPE_WRAP:
		//current_limit = chip->nu1619_chg_status.wpc_chg_param.wrap_input_ma;
		break;
	case ADAPTER_TYPE_SWRAP:
		//current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_input_ma;
		break;
	case ADAPTER_TYPE_SWRAP_50W:
		//current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_input_ma;
		break;
...
int nu1619_charge_set_max_current_by_adapter_power(struct oplus_nu1619_ic *chip)
{
	...
	case ADAPTER_POWER_50W:
		if(chip->nu1619_chg_status.fastchg_current_limit > chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma)
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.swrap_50w_iout_ma;
		break;
	case ADAPTER_POWER_30W:
	case ADAPTER_POWER_20W:
		if(chip->nu1619_chg_status.fastchg_current_limit > chip->nu1619_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma)
			chip->nu1619_chg_status.fastchg_current_limit = chip->nu1619_chg_status.wpc_chg_param.wrap_temp_normal_fastchg_ma;
		break;
	default:
		break;
...
static int nu1619_charge_status_process(struct oplus_nu1619_ic *chip)
{
	...
	case WPC_CHG_STATUS_WAITING_FOR_TX_INTO_FASTCHG:
		...
		if (chip->nu1619_chg_status.vout > 9000 && charger_suspend == true) {
			mp2650_unsuspend_charger();
	...
	case WPC_CHG_STATUS_WAIT_IOUT_READY:
		...
		if (chip->nu1619_chg_status.ftm_mode) {
			...
			if (chip->nu1619_chg_status.adapter_type == ADAPTER_TYPE_WRAP
				|| (g_oplus_chip->wpc_no_chargerpump && chip->nu1619_chg_status.adapter_type == ADAPTER_TYPE_SWRAP)
				|| g_oplus_chip->soc >= 90
				|| g_oplus_chip->temperature < g_oplus_chip->limits.little_cool_bat_decidegc) {
				chip->nu1619_chg_status.charge_status = WPC_CHG_STATUS_CHARGER_FASTCHG_INIT;
			} else {
	...
	case WPC_CHG_STATUS_FAST_CHARGING_FROM_CHARGER:
		...
		if (chip->nu1619_chg_status.engineering_mode == true
			...
			if (nu1619_get_CEP_flag(chip) == 0 && chip->nu1619_chg_status.rx_power == 0) {
				...
				chip->nu1619_chg_status.send_message = P9221_CMD_GET_RXTX_POWER;
				chip->nu1619_chg_status.send_msg_cnt = 10;
				chg_err("<~WPC~> airwrap set rxtx power cmd\n");
				nu1619_set_rxtx_power_cmd(chip);
			}
		}
...
static void nu1619_commu_data_process(struct oplus_nu1619_ic *chip)
{
	...
	if (temp[1] & 0x01) {
		...
		if (val_buf[0] == 0x10) {
			chg_err("<~WPC~> EPP-8W\n");
			chip->nu1619_chg_status.rx_runing_mode = RX_RUNNING_MODE_EPP_8W;
		} else if (val_buf[0] == 0x1e) {
			chg_err("<~WPC~> EPP-15W\n");
			chip->nu1619_chg_status.rx_runing_mode = RX_RUNNING_MODE_EPP_15W;
		} else if (val_buf[0] == 0x14) {
			chg_err("<~WPC~> EPP-10W\n");
		} else if (val_buf[0] == 0x18) {
			chg_err("<~WPC~> EPP-12W\n");
		}
	}
